...
function wp_bootstrap_starter_scripts() {
	...
	wp_enqueue_style( 'wp-bootstrap-starter-style', get_template_directory_uri() . '/inc/assets/css/style.css');
    ...
    if(get_theme_mod( 'preset_color_scheme_setting' ) && get_theme_mod( 'preset_color_scheme_setting' ) !== 'mukta') {
        wp_enqueue_style( 'wp-bootstrap-starter-mukta-font',  'https://fonts.googleapis.com/css2?family=Mukta:wght@200;300;400;500;600;700');
    }
    ...
    wp_enqueue_script('wp-h5p-resizer', 'https://biolandclass.com/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js');
